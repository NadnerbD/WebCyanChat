...
class Parser:
	...
	def escapeCode(self):
		if(self.accept('[')):
			...
			return self.command('setAppKeys', [])
		elif(self.accept('>')):
			return self.command('setNormKeys', [])
		elif(self.accept('(')):
			return self.command('setG0CharSet', self.consume())
		elif(self.accept(')')):
			return self.command('setG1CharSet', self.consume())
		elif(self.accept('E')):
			return self.command('nextLine', [])
		elif(self.accept('D')):
			return self.command('index', [])
		elif(self.accept('M')):
			return self.command('reverseIndex', [])
		elif(self.accept('#') and self.accept('8')):
			return self.command('screenAlignment', [])
		else:
	...
	def paramCmd(self):
		if(self.accept('?')):
			...
			return self.command('saveCursor', [])
		elif(self.accept('u')):
			return self.command('restoreCursor', [])
		...
		if(self.accept('H') or self.accept('f')):
			...
			return self.command('curCharAbs', values[0:1])
		elif(self.accept('J')):
			return self.command('eraseOnDisplay', values[0:1])
		elif(self.accept('K')):
			return self.command('eraseOnLine', values[0:1])
		elif(self.accept('S')):
			return self.command('scrollUp', values[0:1])
		elif(self.accept('T')):
			return self.command('scrollDown', values[0:1])
		elif(self.accept('L')):
			return self.command('insertLines', values[0:1])
		elif(self.accept('M')):
			return self.command('removeLines', values[0:1])
		#ABCD - up, down, forward, back
		elif(self.accept('A')):
			return self.command('cursorUp', values[0:1])
		elif(self.accept('B')):
			return self.command('cursorDown', values[0:1])
		elif(self.accept('C')):
			return self.command('cursorFwd', values[0:1])
		elif(self.accept('D')):
			return self.command('cursorBack', values[0:1])
		elif(self.accept('P')):
			return self.command('deleteChars', values[0:1])
		elif(self.accept('@')):
			return self.command('addBlanks', values[0:1])
		elif(self.accept('X')):
			return self.command('eraseChars', values[0:1])
		else:
	...
	def termCmd(self):
		...
		if(self.accept('T')):
			...
			return self.command('sendDeviceAttributes2', values[0:1])
		elif(self.accept('m')):
			return self.command('setModifierSeqs', values)
		elif(self.accept('n')):
			return self.command('resetModifierSeqs', values)
		elif(self.accept('p')):
			return self.command('setPointerMode', values[0:1])
		elif(self.accept('t')):
			return self.command('setTitleModeFeatures', values[0:1])
		else:
